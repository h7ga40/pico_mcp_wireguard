# pico_mcp_set_lwip_httpd_content(TARGET_LIB TARGET_TYPE HTTPD_FILES...)
# \ingroup\ pico_lwip
...
function(pico_mcp_set_lwip_httpd_content TARGET_LIB TARGET_TYPE)
    find_package (Python3 REQUIRED COMPONENTS Interpreter)
    set(HTTPD_CONTENT_BINARY_DIR "${CMAKE_CURRENT_BINARY_DIR}/generated")
    set(HTTPD_CONTENT_TARGET "${TARGET_LIB}_pico_mcp_set_lwip_httpd_content")
    set(HTTPD_CONTENT_OUTPUT_NAME "pico_fsdata.inc")
    set(HTTPD_CONTENT_TOOL "${CMAKE_SOURCE_DIR}/tools/makefsdata.py")
