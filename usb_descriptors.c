...
// HID report descriptor: keyboard + consumer control + system control
...
uint8_t const desc_configuration[] = {
  ...
  // HID Interface
  TUD_HID_DESCRIPTOR(ITF_NUM_HID, 4, HID_ITF_PROTOCOL_NONE, sizeof(desc_hid_report), EPNUM_HID, 16, 10),
};
